...
func New(output string, url string) (Downloader, error) {
...
func (d *downloader) Start(concurrency int, mergedFilename string) error {
	...
	wg.Wait()
	if err := d.merge(mergedFilename + ".ts"); err != nil {
		return err
	}
	return nil
}
...
func (d *downloader) merge(mergeTSFilename string) error {
